...
public struct AssetConfigLoader {
	...
	public func load(from file: File) -> Result<any SummonAssetConfig & EnchantAssetConfig, AssetConfigLoaderError> {
		do {
	...
	public var defaultConfig: some SummonAssetConfig & EnchantAssetConfig {
